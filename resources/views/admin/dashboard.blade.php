                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4  transparent">
                                <div class="card card-tale">
                                    <div class="card-body">
                                        <p class="mb-4">Total Cars</p>
                                        <p class="fs-30 mb-2">{{ $total_cars }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4  transparent">
                                <div class="card card-dark-blue">
                                    <div class="card-body">
                                        ...
                                        <p class="fs-30 mb-2">{{ $total_bookings }}</p>
                                    </div>
                                </div>
                            </div>


                            <div class="col-md-4 mb-4 mb-lg-0  transparent">
                            ...
                            <div class="col-md-4 mb-4  transparent">
                                <div class="card card-light-danger">
                                    <div class="card-body">
                                        ...
                                        <p class="fs-30 mb-2">{{ $total_posts }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4  transparent">
                                <div class="card card-light-danger">
                                    <div class="card-body">
                                        ...
                                        <p class="fs-30 mb-2">{{ $total_services }}</p>
                                    </div>
                                </div>
                            </div>
