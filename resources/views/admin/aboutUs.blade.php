    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <form action="{{ url('create_about_us') }}" method="post">

                    @csrf

                    <div class="mb-3">
                        <label>About Us Description</label>
                        <textarea class="form-control text-dark" id="#" rows="20" cols="30"  placeholder="Post Details..." name="description"  required></textarea>
                    </div>
