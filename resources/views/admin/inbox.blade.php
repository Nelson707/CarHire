            ...
            <ul class="navbar-nav mr-lg-2">
                ...
                <span class="input-group-text" id="search">
                  <i class="icon-search"></i>
                        ...
                        <form action="{{url('search_messages')}}" method="get">
            ...
            <div class="content-wrapper">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('delete_message', $contact->id)}}" onclick="return confirm('Are you sure you want to delete this message?')" class="btn btn-danger">Clear Record</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
